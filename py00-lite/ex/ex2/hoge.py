...
print("Special cases aren't special enough to brake rules.")
print("Altough practicality beats purity.")
...
print("If the implementation is easy to explain, it's may be a good idea.")
